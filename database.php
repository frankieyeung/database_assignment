<?php   
    ...
    function create_tables($databaseConnection)
    {
        ...
        $query_projects = "CREATE TABLE IF NOT EXISTS projects (id INT NOT NULL AUTO_INCREMENT, project_title VARCHAR(50), project_category VARCHAR(50), project_description TEXT, project_file_name VARCHAR(255), PRIMARY KEY (id))";
